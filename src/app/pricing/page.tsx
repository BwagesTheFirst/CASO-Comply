...
export const metadata: Metadata = {
  ...
  description:
    "Simple, transparent pricing for AI-powered document accessibility remediation. Plans starting at $299/month for PDFs, Word documents, and Excel spreadsheets.",
};
...
const PLANS = [
  {
    ...
    period: "/mo",
    description:
      "For small teams getting started with document accessibility compliance.",
    features: [
      "500 pages/month",
      "1 domain",
  ...
  },
  {
    ...
    period: "/mo",
    description:
      "For organizations managing multiple sites with higher document volumes.",
    features: [
      "2,000 pages/month",
      "5 domains",
      "PDF, Word & Excel support",
  ...
  },
  {
    ...
    period: "/mo",
    description:
      "For large organizations with high-volume remediation and custom requirements.",
    features: [
      "10,000 pages/month",
      "Unlimited domains",
      "PDF, Word & Excel support",
    ...
    cta: "Contact Sales",
    ctaHref: "mailto:sales@caso.com?subject=CASO%20Comply%20Enterprise%20Inquiry",
    featured: false,
  },
];
