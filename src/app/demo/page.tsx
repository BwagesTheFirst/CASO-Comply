                ...
                <span
                  className={`flex h-8 w-8 items-center justify-center rounded-full text-xs font-bold transition-all duration-500 ${
                    isComplete
                      ...
                      : isActive
                        ? "step-active bg-caso-blue-deep text-caso-white shadow-lg shadow-caso-blue/30"
          ...
          {state === "error" && (
            <div className="demo-fade-in mx-auto max-w-xl">
              <div className="rounded-2xl border border-caso-red-dark/30 bg-caso-red/5 p-8 text-center">
                ...
                <button
                  onClick={handleReset}
                  className="mt-6 rounded-xl bg-caso-blue-deep px-6 py-3 text-sm font-bold text-caso-white transition-all hover:bg-caso-blue hover:shadow-lg hover:shadow-caso-blue/25"
                >
                  Try Again
                </button>
              </div>
            ...
            <div ref={resultsRef} className="demo-fade-in">
              ...
              <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                <button
                  ...
                  className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-caso-blue-deep px-8 py-4 text-base font-bold text-caso-white transition-all hover:bg-caso-blue hover:shadow-lg hover:shadow-caso-blue/25 sm:w-auto"
                ...
                {auditEmailState === "sent" ? (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-2 rounded-xl bg-caso-blue-deep px-6 py-3.5 text-sm font-bold text-caso-white transition-all hover:bg-caso-blue hover:shadow-lg hover:shadow-caso-blue/25 disabled:opacity-60"
                    >
