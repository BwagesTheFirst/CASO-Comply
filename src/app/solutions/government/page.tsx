...
const CREDENTIALS = [
  ...
  "40+ years of document management experience",
      ...
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            ADA Title II Document Compliance for Government
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            The DOJ&apos;s final rule on ADA Title II digital accessibility is
            here. Every PDF, document, and digital asset on your government
            website must meet WCAG 2.1 AA standards — or face enforcement.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              The DOJ published its final rule on April 24, 2024. Compliance
              deadlines are based on population size.
            </p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy p-8">
              ...
              <p className="mt-2 text-caso-slate">
                State and local governments serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy p-8">
              ...
              <p className="mt-2 text-caso-slate">
                State and local governments serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Title II applies to all digital content and services offered by
      ...
      <section className="border-b border-caso-border/50 bg-caso-navy-light px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              ADA violations carry real financial and legal consequences for
              government agencies and their leadership.
            </p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2">
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for government document accessibility — from
      ...
      <section className="border-b border-caso-border/50 bg-caso-navy-light px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              CASO has served government clients for over four decades. We
              understand procurement, compliance requirements, and the stakes
              involved.
            </p>
          </div>
