...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Colorado — CASO Comply",
  description:
    "Colorado agencies must meet HB 21-1110 WCAG 2.1 AA requirements and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Colorado — CASO Comply",
    description:
      "Colorado agencies must meet HB 21-1110 WCAG 2.1 AA requirements and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/colorado",
  },
};
...
const STATE_LAWS = [
  {
    title: "House Bill 21-1110 (HB 21-1110)",
    description:
  ...
  {
    title: "HB 24-1454 (Grace Period Extension)",
    description:
  ...
  {
    title: "Colorado OIT Oversight & Accessibility Plans",
    description:
  ...
  {
    title: "$3,500 Per-Violation Penalty",
    description:
...
export default function ColoradoSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            Colorado HB 21-1110 + ADA Title II Compliance
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Colorado set the standard as the first state to require both state and
            local government digital platforms to meet WCAG 2.1 AA — including
            documents, not just websites. HB 21-1110 carries $3,500 per-violation
            fines, and the federal ADA Title II rule adds another layer of
            enforcement. CASO Comply remediates your PDFs and documents at scale
            so you can meet both requirements.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Colorado&apos;s HB 21-1110 is one of the most comprehensive state
              digital accessibility laws in the country — covering state and local
              government, K-12 schools, and universities.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Colorado agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Colorado municipalities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Colorado document accessibility — from discovery
      ...
      <section className="px-6 py-20 md:py-28">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="font-[family-name:var(--font-display)] text-3xl font-bold md:text-4xl">
            Start Your Colorado Compliance Assessment
          </h2>
          <p className="mt-4 text-lg text-caso-slate">
