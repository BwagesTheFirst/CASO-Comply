...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Arkansas — CASO Comply",
  description:
    "Arkansas agencies must meet Act 1227 accessibility standards and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Arkansas — CASO Comply",
    description:
      "Arkansas agencies must meet Act 1227 accessibility standards and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/arkansas",
  },
};
...
const STATE_LAWS = [
  ...
  {
    title: "Act 308 of 2013 (Amendment to Act 1227)",
    description:
  ...
  {
    title: "Arkansas DIS Non-Visual Access Standards",
    description:
...
export default function ArkansasSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Arkansas has had a state web accessibility law on the books since 1999.
            Act 1227 requires all government and state-funded entities to make their
            websites accessible to users who are blind or visually impaired. Now the
            federal ADA Title II rule extends that to all disabilities and all web
            content — including PDFs. CASO Comply remediates those documents
            automatically so you can meet both requirements.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Arkansas was one of the earlier states to pass a digital accessibility
              law. Act 1227 has been in effect since 1999, and Act 308 strengthened it
              in 2013.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Arkansas agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Arkansas entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Arkansas document accessibility — from discovery
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                Standard 530S2 and ADA Title II compliance for Alabama state agencies.
              </p>
            </Link>
          </div>
        </div>
