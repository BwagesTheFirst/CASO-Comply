...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Connecticut — CASO Comply",
  description:
    "Connecticut agencies must meet the OPM Universal Website Accessibility Policy (WCAG 2.1 AA) and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Connecticut — CASO Comply",
    description:
      "Connecticut agencies must meet the OPM Universal Website Accessibility Policy (WCAG 2.1 AA) and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/connecticut",
  },
};
...
const STATE_LAWS = [
  {
    title: "OPM Universal Website Accessibility Policy",
    description:
  ...
  {
    title: "WCAG 2.1 Level AA Adoption",
    description:
  ...
  {
    title: "State Digital Accessibility Policy (2025)",
    description:
  ...
  {
    title: "Agency Accessibility Designee Requirement",
    description:
...
export default function ConnecticutSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Connecticut has had a Universal Website Accessibility Policy since
            2000, and it now formally requires WCAG 2.1 Level AA for all state
            digital content. The federal ADA Title II web rule adds enforceable
            deadlines on top of that. For Connecticut agencies, every public-facing
            document — including PDFs — needs to be accessible. CASO Comply
            remediates them automatically instead of one at a time.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Connecticut&apos;s OPM has maintained accessibility policy for over two
              decades. The latest version explicitly requires WCAG 2.1 AA for all
              digital content — not just websites.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Connecticut agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Connecticut municipalities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Connecticut document accessibility — from
      ...
      <section className="border-t border-caso-border px-6 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Link
              href="/solutions/states/district-of-columbia"
              className="group rounded-xl border border-caso-border bg-caso-navy-light p-6 transition-colors hover:border-caso-blue/50"
            >
              <h3 className="font-[family-name:var(--font-display)] text-lg font-bold text-caso-white group-hover:text-caso-blue">
              ...
              <p className="mt-2 text-sm text-caso-slate">
                DC Human Rights Act and ADA Title II compliance for District agencies.
              </p>
            </Link>
          </div>
        </div>
