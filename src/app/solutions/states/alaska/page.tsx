...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Alaska — CASO Comply",
  description:
    "Alaska agencies must meet federal ADA Title II web accessibility deadlines. CASO Comply automates PDF remediation at scale for state and local government.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Alaska — CASO Comply",
    description:
      "Alaska agencies must meet federal ADA Title II web accessibility deadlines. CASO Comply automates PDF remediation at scale for state and local government.",
  ...
  alternates: {
    canonical: "/solutions/states/alaska",
  },
};
...
const STATE_LAWS = [
  {
    title: "Administrative Order No. 262",
    description:
  ...
  {
    title: "State ADA Compliance Program",
    description:
  ...
  {
    title: "OIT Enterprise Technology Standards",
    description:
...
export default function AlaskaSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            Alaska Digital Accessibility + ADA Title II Compliance
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Alaska&apos;s state agencies follow Section 508 and WCAG standards
            through the Office of Information Technology and the State ADA
            Compliance Program. Now the federal ADA Title II web rule is putting
            an enforceable deadline on it. For Alaska agencies, every
            public-facing document — including PDFs — needs to meet WCAG 2.1 AA.
            CASO Comply handles that automatically.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Alaska follows federal accessibility standards and has its own ADA
              compliance program. The federal deadline now adds enforcement teeth.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Alaska agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Alaska boroughs and entities serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Alaska document accessibility — from discovery
