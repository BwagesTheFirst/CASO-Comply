...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Maine — CASO Comply",
  description:
    "Maine's Digital Accessibility Policy and Title 5 §1973 require WCAG 2.1 AA compliance. CASO Comply automates PDF remediation at scale for Maine agencies.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Maine — CASO Comply",
    description:
      "Maine's Digital Accessibility Policy and Title 5 §1973 require WCAG 2.1 AA compliance. CASO Comply automates PDF remediation at scale for Maine agencies.",
  ...
  alternates: {
    canonical: "/solutions/states/maine",
  },
};
...
const STATE_LAWS = [
  {
    title: "Maine Digital Accessibility and Usability Policy",
    description:
  ...
  {
    title: "Title 5, Chapter 163 §1973 — CIO Authority",
    description:
  ...
  {
    title: "Maine Civil Rights Act Enforcement",
    description:
  ...
  {
    title: "Vendor Accessibility Requirements",
    description:
...
const THREE_REASONS = [
  {
    title: "Avoid $5,000-Per-Violation Penalties",
    description:
  ...
  {
    title: "Satisfy Both State and Federal Requirements",
    description:
...
export default function MaineSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            Maine Digital Accessibility + ADA Title II Compliance
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Maine&apos;s Digital Accessibility and Usability Policy already
            requires WCAG 2.1 AA for all public-facing content, and the Attorney
            General can enforce it with $5,000 per-violation penalties under the
            Maine Civil Rights Act. Now the federal ADA Title II rule adds
            another deadline. CASO Comply remediates your PDFs and documents at
            scale so you meet both requirements without the manual work.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Maine has one of the more complete state-level accessibility
              frameworks — policy, CIO authority, vendor requirements, and
              enforcement with real penalties. CASO Comply handles the document
              piece.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Maine agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Maine entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Maine document accessibility — from discovery
