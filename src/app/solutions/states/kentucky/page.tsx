...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Kentucky — CASO Comply",
  description:
    "Kentucky agencies must meet the Accessible Information Technology Act (KRS 61.980–61.988) and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Kentucky — CASO Comply",
    description:
      "Kentucky agencies must meet the Accessible Information Technology Act (KRS 61.980–61.988) and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/kentucky",
  },
};
...
const STATE_LAWS = [
  {
    title: "Kentucky AIT Act (KRS 61.980–61.988)",
    description:
  ...
  {
    title: "Broad Institutional Coverage",
    description:
  ...
  {
    title: "Technology Access Clause in Contracts",
    description:
...
const THREE_REASONS = [
  {
    title: "Cover the Full AIT Act Scope",
    description:
  ...
  {
    title: "Meet Procurement Requirements Automatically",
    description:
...
export default function KentuckySolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            Kentucky AIT Act Accessibility + ADA Title II Compliance
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Kentucky passed its Accessible Information Technology Act back in
            2000 — one of the earlier states to put IT accessibility into law.
            KRS 61.980 through 61.988 covers state agencies, schools,
            universities, and even nonprofits receiving state funds. With the
            federal ADA Title II deadline now in effect, the Commonwealth&apos;s
            entities need to get their public-facing documents compliant. CASO
            Comply automates that at scale.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Kentucky&apos;s AIT Act has been on the books for over two decades,
              covering everything from state agencies to schools to local
              governments. CASO Comply automates the document remediation piece.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Kentucky agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Kentucky entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Kentucky document accessibility — from discovery
