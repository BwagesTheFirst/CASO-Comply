...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Wyoming — CASO Comply",
  description:
    "Wyoming agencies must meet the A&I Web Communication Accessibility Standard and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Wyoming — CASO Comply",
    description:
      "Wyoming agencies must meet the A&I Web Communication Accessibility Standard and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/wyoming",
  },
};
...
const STATE_LAWS = [
  {
    title: "Wyoming A&I Web Communication Accessibility Standard",
    description:
  ...
  {
    title: "A&I Policies & Procedures for State Agencies",
    description:
  ...
  {
    title: "Section 508 Alignment (Federal Standard)",
    description:
  ...
  {
    title: "Federal ADA Title II (Applies to All Wyoming Public Entities)",
    description:
...
export default function WyomingSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-sm font-bold uppercase tracking-widest text-caso-glacier">
            Solutions for Wyoming
          </p>
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            Wyoming Accessibility Standards + ADA Title II Compliance
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Wyoming&apos;s Department of Administration and Information already
            has a Web Communication Accessibility Standard in place, and state
            agencies follow federal Section 508 guidelines. But the ADA Title II
            rule is the first time there&apos;s an enforceable deadline with
            teeth — and it covers PDFs and documents, not just websites. CASO
            Comply remediates those documents at scale so your team doesn&apos;t
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Wyoming&apos;s A&I department sets the web accessibility standard
              for state sites, and agencies follow federal Section 508. The ADA
              Title II rule now makes WCAG 2.1 AA the enforceable standard.
              CASO Comply handles the document remediation at scale.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              ...
              includes documents posted on the site — which means every
              public-facing PDF on a Wyoming government website is in scope.
            </p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Wyoming agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Wyoming entities and municipalities serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Wyoming document accessibility — from
