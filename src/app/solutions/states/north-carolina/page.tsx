...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for North Carolina — CASO Comply",
  description:
    "North Carolina's Digital Accessibility and Usability Standard and N.C.G.S. 143B Article 15 require WCAG 2.1 AA compliance for state agencies. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for North Carolina — CASO Comply",
    description:
      "North Carolina's Digital Accessibility and Usability Standard and N.C.G.S. 143B Article 15 require WCAG 2.1 AA compliance for state agencies. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/north-carolina",
  },
};
...
const STATE_LAWS = [
  {
    title: "NC Digital Accessibility and Usability Standard",
    description:
  ...
  {
    title: "N.C.G.S. 143B Article 15 — State CIO Authority",
    description:
  ...
  {
    title: "NCDIT Section 508 Compliance Standards",
    description:
  ...
  {
    title: "NCDIT Digital Accessibility Support Program",
    description:
...
const THREE_REASONS = [
  {
    title: "NCDIT's Standard Is Active and Enforced",
    description:
  ...
  {
    title: "100 Counties, Thousands of PDFs",
    description:
...
export default function NorthCarolinaSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            North Carolina&apos;s NCDIT Digital Accessibility and Usability
            Standard requires WCAG 2.1 AA for all state agency digital content,
            and the federal ADA Title II rule extends that requirement to every
            county and municipality. Public-facing PDFs are in scope — and CASO
            Comply remediates them at scale instead of one at a time.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              North Carolina has a comprehensive statewide accessibility standard
              managed by NCDIT, with active support programs for agencies working
              toward compliance.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              ...
              which puts PDFs squarely in scope for North Carolina agencies,
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                North Carolina agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller North Carolina counties and municipalities serving
                populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for North Carolina document accessibility —
              from discovery to remediation to ongoing compliance.
            </p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                Accessibility standards and ADA Title II compliance for South Carolina public entities.
              </p>
            </Link>
            <Link
