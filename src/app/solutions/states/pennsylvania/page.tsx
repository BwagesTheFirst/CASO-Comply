...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Pennsylvania — CASO Comply",
  description:
    "Pennsylvania agencies must meet ITP-ACC001 digital accessibility policy and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Pennsylvania — CASO Comply",
    description:
      "Pennsylvania agencies must meet ITP-ACC001 digital accessibility policy and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/pennsylvania",
  },
};
...
const STATE_LAWS = [
  {
    title: "ITP-ACC001 — Digital Accessibility Policy",
    description:
  ...
  {
    title: "WCAG 2.2 AA Target Standard",
    description:
  ...
  {
    title: "Vendor and Procurement Requirements",
    description:
...
const THREE_REASONS = [
  {
    title: "Match Pennsylvania's Higher Bar",
    description:
  ...
  {
    title: "Scale Across the Commonwealth",
    description:
...
export default function PennsylvaniaSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            Pennsylvania ITP-ACC001 + ADA Title II Compliance
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Pennsylvania already sets a high bar with ITP-ACC001, which targets
            WCAG 2.2 AA for all Commonwealth agencies — that&apos;s actually
            stricter than the federal ADA Title II minimum. But policy is one
            thing and thousands of legacy PDFs are another. CASO Comply
            remediates those documents at scale so your agency meets both
            the state policy and the federal deadline.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Pennsylvania&apos;s ITP-ACC001 policy already mandates accessible
              websites, apps, documents, and media across the Commonwealth.
              CASO Comply handles the document remediation piece at scale.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Pennsylvania agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Pennsylvania entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Pennsylvania document accessibility — from discovery
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                IT-09 policy and ADA Title II compliance for Ohio public entities.
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                State Technology Law and ADA Title II compliance for New York public entities.
              </p>
            </Link>
          </div>
        </div>
