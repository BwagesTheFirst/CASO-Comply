...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for New Mexico — CASO Comply",
  description:
    "New Mexico's Accessibility Act (HB 120) targets WCAG 2.1 AA compliance for state agency websites by April 2026. Meet state and federal ADA Title II deadlines with CASO Comply.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for New Mexico — CASO Comply",
    description:
      "New Mexico's Accessibility Act (HB 120) targets WCAG 2.1 AA compliance for state agency websites by April 2026. Meet state and federal ADA Title II deadlines with CASO Comply.",
  ...
  alternates: {
    canonical: "/solutions/states/new-mexico",
  },
};
...
const STATE_LAWS = [
  {
    title: "New Mexico Accessibility Act (HB 120)",
    description:
  ...
  {
    title: "HB 120 — Private Right of Action",
    description:
  ...
  {
    title: "HB 120 — Office of Accessibility",
    description:
  ...
  {
    title: "Federal ADA Title II Requirements",
    description:
...
const THREE_REASONS = [
  {
    title: "State and Federal Pressure Are Converging",
    description:
  ...
  {
    title: "Serve New Mexico's Diverse Communities",
    description:
...
export default function NewMexicoSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            New Mexico&apos;s legislature introduced the Accessibility Act (HB
            120) targeting WCAG 2.1 AA for state agency websites, and the
            federal ADA Title II rule applies to all public entities regardless.
            For New Mexico agencies, that means public-facing PDFs need to be
            accessible — and CASO Comply automates that remediation at scale.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              New Mexico has pushed for state-level accessibility legislation,
              and the federal ADA Title II rule creates binding deadlines for all
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              ...
              which puts PDFs squarely in scope for New Mexico agencies and
              municipalities.
            </p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                New Mexico agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller New Mexico entities and municipalities serving
                populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for New Mexico document accessibility — from
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                NRS Chapter 242 and ADA Title II compliance for Nevada state agencies.
              </p>
            </Link>
          </div>
        </div>
