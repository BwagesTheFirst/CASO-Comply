...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Rhode Island — CASO Comply",
  description:
    "Rhode Island agencies must meet OLIS Minimum Website Standards, IRMB accessibility policy, and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Rhode Island — CASO Comply",
    description:
      "Rhode Island agencies must meet OLIS Minimum Website Standards, IRMB accessibility policy, and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/rhode-island",
  },
};
...
const STATE_LAWS = [
  {
    title: "IRMB Accessibility Policy (1997)",
    description:
  ...
  {
    title: "OLIS Minimum Standards for State Websites",
    description:
  ...
  {
    title: "PDF Accessibility Requirements",
    description:
  ...
  {
    title: "Governor's Commission on Disabilities",
    description:
...
const THREE_REASONS = [
  {
    title: "Fix the PDF Problem Rhode Island Named",
    description:
...
export default function RhodeIslandSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Rhode Island has required accessible state websites since 1997 —
            one of the earliest states to adopt a formal digital accessibility
            policy. The OLIS minimum standards even call out PDF accessibility
            specifically. Now the federal ADA Title II rule adds enforceable
            deadlines. CASO Comply remediates documents at scale so your
            agency meets both the state standards and the federal mandate.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Rhode Island was ahead of most states on digital accessibility,
              with formal IRMB policy dating back to 1997. The OLIS minimum
              standards specifically address PDF formats. CASO Comply
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Rhode Island agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Rhode Island entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Rhode Island document accessibility — from discovery
