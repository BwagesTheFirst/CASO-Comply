...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Tennessee — CASO Comply",
  description:
    "Tennessee agencies must meet STS enterprise IT policies and the federal ADA Title II deadline for web and document accessibility. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Tennessee — CASO Comply",
    description:
      "Tennessee agencies must meet STS enterprise IT policies and the federal ADA Title II deadline for web and document accessibility. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/tennessee",
  },
};
...
const STATE_LAWS = [
  {
    title: "STS Enterprise IT Policies",
    description:
  ...
  {
    title: "ISC Information Resources Policies",
    description:
  ...
  {
    title: "Tennessee Technology Access Program (TTAP)",
    description:
...
const THREE_REASONS = [
  {
    title: "The Federal Deadline Doesn't Wait for State Law",
    description:
  ...
  {
    title: "Scale Across 95 Counties and Hundreds of Cities",
    description:
...
export default function TennesseeSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            Tennessee Digital Accessibility + ADA Title II Compliance
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Tennessee doesn&apos;t have a standalone digital accessibility
            statute, but that doesn&apos;t mean agencies are off the hook. The
            federal ADA Title II web rule applies to every state and local
            government entity, and Tennessee&apos;s STS division is already
            assessing where improvements are needed. For public-facing PDFs,
            CASO Comply automates remediation at scale so your agency can meet
            the federal deadline without scrambling.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              While Tennessee lacks a dedicated digital accessibility law, the
              state&apos;s STS enterprise policies and TTAP program both push
              toward accessible technology. The federal ADA Title II rule now
              puts hard deadlines on it.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Tennessee agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Tennessee entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Tennessee document accessibility — from discovery
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                ADA Title II compliance for South Carolina state and local government entities.
              </p>
            </Link>
            <Link
              href="/solutions/states/oklahoma"
              className="group rounded-xl border border-caso-border bg-caso-navy-light p-6 transition-colors hover:border-caso-blue/50"
            >
              <h3 className="font-[family-name:var(--font-display)] text-lg font-bold text-caso-white group-hover:text-caso-blue">
                Oklahoma
              ...
              <p className="mt-2 text-sm text-caso-slate">
                EITA Act and ADA Title II compliance for Oklahoma agencies and institutions.
              </p>
            </Link>
          </div>
        </div>
