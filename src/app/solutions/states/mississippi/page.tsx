...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Mississippi — CASO Comply",
  description:
    "Mississippi agencies must meet federal ADA Title II web accessibility requirements. CASO Comply automates PDF remediation at scale for Mississippi government entities.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Mississippi — CASO Comply",
    description:
      "Mississippi agencies must meet federal ADA Title II web accessibility requirements. CASO Comply automates PDF remediation at scale for Mississippi government entities.",
  ...
  alternates: {
    canonical: "/solutions/states/mississippi",
  },
};
...
const STATE_LAWS = [
  {
    title: "MS.GOV Accessibility Policy",
    description:
  ...
  {
    title: "BEAM Digital Skills and Accessibility Plan",
    description:
  ...
  {
    title: "BEAM WCAG Compliance Guide",
    description:
  ...
  {
    title: "Federal ADA Title II Mandate",
    description:
...
const THREE_REASONS = [
  {
    title: "Get Ahead Without a State Playbook",
    description:
  ...
  {
    title: "Federal Deadlines Don't Wait for State Guidance",
    description:
...
export default function MississippiSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            Mississippi ADA Title II Web Accessibility Compliance
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Mississippi doesn&apos;t have a standalone state digital
            accessibility law, but that doesn&apos;t mean agencies are off the
            hook. The federal ADA Title II web rule requires WCAG 2.1 AA
            compliance for all state and local government digital content —
            including PDFs. While BEAM works on the state&apos;s compliance
            guide, CASO Comply gives Mississippi agencies a way to remediate
            documents at scale right now.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Mississippi relies on BEAM&apos;s guidance and federal ADA
              requirements rather than a standalone state law. The federal
              mandate still applies in full. CASO Comply handles the document
              remediation piece.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Mississippi agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Mississippi entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Mississippi document accessibility — from discovery
      ...
      <section className="border-t border-caso-border px-6 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Link
              href="/solutions/states/louisiana"
              className="group rounded-xl border border-caso-border bg-caso-navy-light p-6 transition-colors hover:border-caso-blue/50"
            >
              <h3 className="font-[family-name:var(--font-display)] text-lg font-bold text-caso-white group-hover:text-caso-blue">
                Louisiana
              ...
              <p className="mt-2 text-sm text-caso-slate">
                PPM 74 and ADA Title II compliance for Louisiana state agencies.
              </p>
            </Link>
            <Link
