...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Kansas — CASO Comply",
  description:
    "Kansas agencies must meet ITEC Policy 1210 (WCAG 2.1 AA, Section 508) and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Kansas — CASO Comply",
    description:
      "Kansas agencies must meet ITEC Policy 1210 (WCAG 2.1 AA, Section 508) and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/kansas",
  },
};
...
const STATE_LAWS = [
  {
    title: "ITEC Policy 1210-P Revision 4",
    description:
  ...
  {
    title: "Kansas Partnership for Accessible Technology (KPAT)",
    description:
  ...
  {
    title: "Contractor & Vendor Accessibility Requirements",
    description:
  ...
  {
    title: "Education Institution Coverage",
    description:
...
const THREE_REASONS = [
  {
    title: "Act on What KPAT's AMP Finds",
    description:
  ...
  {
    title: "Cover Agencies and Schools Alike",
    description:
...
export default function KansasSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Kansas has had ICT accessibility standards since 2000, and ITEC
            Policy 1210 now requires WCAG 2.1 AA, Section 508 conformance, and
            ADA Title II compliance for every state entity — including education
            institutions and their contractors. With KPAT actively monitoring and
            the federal deadline in effect, Kansas agencies need to move from
            scanning to fixing. CASO Comply remediates documents at scale.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Kansas has one of the longest-standing state ICT accessibility
              policies in the country, with active monitoring through KPAT. CASO
              Comply automates the remediation that makes compliance real.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Kansas agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Kansas entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Kansas document accessibility — from discovery
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                State accessibility standards and ADA Title II compliance for North Dakota agencies.
              </p>
            </Link>
          </div>
        </div>
