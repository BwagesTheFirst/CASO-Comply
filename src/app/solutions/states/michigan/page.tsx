...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Michigan — CASO Comply",
  description:
    "Michigan agencies must meet Administrative Guide Policy 1650 and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Michigan — CASO Comply",
    description:
      "Michigan agencies must meet Administrative Guide Policy 1650 and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/michigan",
  },
};
...
const STATE_LAWS = [
  {
    title: "Administrative Guide Policy 1650",
    description:
  ...
  {
    title: "SOM Digital Standards — WCAG 2.1 AA",
    description:
  ...
  {
    title: "Michigan Persons with Disabilities Civil Rights Act",
    description:
  ...
  {
    title: "State IT Accessibility Compliance Mandate",
    description:
...
const THREE_REASONS = [
  {
    title: "Clear the Document Backlog Before Enforcement",
    description:
  ...
  {
    title: "Meet Policy 1650 Without Adding Staff",
    description:
...
export default function MichiganSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Michigan adopted WCAG 2.1 Level AA as its digital accessibility
            standard in 2024, and Administrative Guide Policy 1650 requires
            every Executive Branch agency to make websites, apps, and electronic
            documents accessible. All non-compliant digital content must be
            remediated before the federal enforcement date. CASO Comply
            automates PDF and document remediation at scale so Michigan agencies
            can meet both state and federal deadlines.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Michigan adopted WCAG 2.1 AA in 2024 and explicitly includes
              electronic documents in scope. CASO Comply handles the document
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Michigan agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Michigan entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Michigan document accessibility — from discovery
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                Minnesota IT accessibility standards and ADA Title II compliance for state agencies.
              </p>
            </Link>
          </div>
        </div>
