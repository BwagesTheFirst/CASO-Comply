...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Massachusetts — CASO Comply",
  description:
    "Massachusetts agencies must meet the Enterprise Digital Accessibility Policy (MGL Ch. 7D) and ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Massachusetts — CASO Comply",
    description:
      "Massachusetts agencies must meet the Enterprise Digital Accessibility Policy (MGL Ch. 7D) and ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/massachusetts",
  },
};
...
const STATE_LAWS = [
  {
    title: "Enterprise Digital Accessibility Policy",
    description:
  ...
  {
    title: "MGL Chapter 7D — EOTSS Authority",
    description:
  ...
  {
    title: "Chief IT Accessibility Officer",
    description:
  ...
  {
    title: "Capital Funding Enforcement",
    description:
...
const THREE_REASONS = [
  {
    title: "Meet the PDF/UA Requirement",
    description:
  ...
  {
    title: "Protect Your Capital Funding",
    description:
...
export default function MassachusettsSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Massachusetts sets a high bar — the Enterprise Digital Accessibility
            Policy requires WCAG 2.1 AA for all digital assets, and PDFs must
            meet the PDF/UA standard (ISO 14289). Agencies that fall short risk
            losing capital funding. With the federal ADA Title II deadline on
            top, CASO Comply remediates your documents at scale so you meet both
            the Commonwealth&apos;s and federal requirements fast.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              The Commonwealth goes further than most states — PDF/UA compliance,
              a Chief IT Accessibility Officer, and capital funding tied to
              accessibility. CASO Comply handles the document remediation at scale.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Massachusetts agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Massachusetts entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Massachusetts document accessibility — from
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                Digital Accessibility Policy and ADA Title II compliance for Maine state agencies.
              </p>
            </Link>
            <Link
