...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Arizona — CASO Comply",
  description:
    "Arizona agencies must meet ADOA-ASET statewide accessibility policy (P800) and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Arizona — CASO Comply",
    description:
      "Arizona agencies must meet ADOA-ASET statewide accessibility policy (P800) and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/arizona",
  },
};
...
const STATE_LAWS = [
  {
    title: "ADOA-ASET Statewide Accessibility Policy",
    description:
      "The Arizona Department of Administration's Strategic Enterprise Technology Office establishes a statewide policy to lower technical barriers to accessibility on all Arizona government websites.",
  },
  {
    title: "Policy P800: Web Site Standards & Guidelines",
    description:
      "ASET's P800 policy sets web standards including accessibility requirements for all state budget units — departments, boards, commissions, and agencies that handle state funds.",
  },
  {
    title: "Arizona Statewide IT Standards (Section 508 Alignment)",
    description:
      "Arizona's IT standards align with Section 508 of the Rehabilitation Act, covering color contrast, form labeling, downloadable files including PDFs, and multimedia content accessibility.",
  },
  {
    title: "ADA Title II Federal Mandate",
    description:
      "The DOJ's 2024 final rule requires all Arizona state and local government web content — including posted PDFs — to conform to WCAG 2.1 Level AA by the applicable deadline.",
  },
];
...
const THREE_REASONS = [
  {
    ...
    description:
      "Arizona agencies across the state — from Maricopa County offices to the Arizona Department of Education — have years of PDFs sitting on their websites. Budget requests, permit forms, school district reports. Manual remediation is too slow for the volume. CASO Comply automates it so you can clear the backlog without pulling staff off other work.",
  },
  {
    title: "Stay Compliant on Every New Upload",
    description:
      "Even after older documents are fixed, new PDFs get posted across Arizona government sites every day. CASO Comply gives you a repeatable process to make every new document accessible at the point of publishing, so you stay in compliance as content grows.",
  },
  {
    title: "No Accessibility Expertise Required",
    description:
      "Most Arizona departments and municipalities don't have WCAG or PDF/UA specialists on staff. CASO Comply applies the right structure tags, alt text, reading order, and metadata automatically — so IT or Records teams can meet both ASET policy and the federal ADA deadline without hiring specialists.",
  },
];

export default function ArizonaSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            Arizona ASET Accessibility + ADA Title II Compliance
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Arizona&apos;s ADOA-ASET already sets statewide accessibility policy
            under P800 for every state budget unit, and the federal ADA Title II web
            rule is now putting a hard deadline on it. For Arizona agencies, that
            means every public-facing document — including PDFs, forms, and
            downloadable files — needs to meet WCAG 2.1 AA. CASO Comply remediates
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            <h2 className="font-[family-name:var(--font-display)] text-3xl font-bold md:text-4xl">
              What Arizona Already Requires
            </h2>
            <p className="mt-4 text-lg text-caso-slate">
              ADOA-ASET already tells Arizona agencies to make web content accessible
              — including downloadable documents. The federal deadline just makes
              it enforceable.
            </p>
          </div>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            <h2 className="font-[family-name:var(--font-display)] text-3xl font-bold md:text-4xl">
              The Federal Clock Arizona Is On
            </h2>
            <p className="mt-4 text-lg text-caso-slate">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Arizona agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Arizona municipalities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 bg-caso-navy-light px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            <h2 className="font-[family-name:var(--font-display)] text-3xl font-bold md:text-4xl">
              Why Arizona Entities Choose CASO Comply
            </h2>
          </div>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Arizona document accessibility — from discovery
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                AB 434 and ADA Title II compliance for California state agencies.
              </p>
            </Link>
            <Link
              href="/solutions/states/colorado"
              className="group rounded-xl border border-caso-border bg-caso-navy-light p-6 transition-colors hover:border-caso-blue/50"
            >
              <h3 className="font-[family-name:var(--font-display)] text-lg font-bold text-caso-white group-hover:text-caso-blue">
                Colorado
              ...
              <p className="mt-2 text-sm text-caso-slate">
                HB 21-1110 and ADA Title II compliance for Colorado government entities.
              </p>
            </Link>
          </div>
        </div>
      ...
      <section className="px-6 py-20 md:py-28">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="font-[family-name:var(--font-display)] text-3xl font-bold md:text-4xl">
            Start Your Arizona Compliance Assessment
          </h2>
          <p className="mt-4 text-lg text-caso-slate">
