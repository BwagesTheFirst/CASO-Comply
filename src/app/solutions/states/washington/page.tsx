...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Washington — CASO Comply",
  description:
    "Washington agencies must meet WaTech Policy USER-01, the Minimum Accessibility Standard, and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Washington — CASO Comply",
    description:
      "Washington agencies must meet WaTech Policy USER-01, the Minimum Accessibility Standard, and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/washington",
  },
};
...
const STATE_LAWS = [
  {
    title: "WaTech Policy USER-01 — Digital Accessibility",
    description:
  ...
  {
    title: "USER-01-01-S — Minimum Accessibility Standard",
    description:
  ...
  {
    title: "RCW 43.105.054 — WaTech Governance Authority",
    description:
  ...
  {
    title: "Agency Accessibility Coordinator Requirement",
    description:
...
export default function WashingtonSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            Washington Digital Accessibility + ADA Title II Compliance
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Washington is ahead of most states on digital accessibility.
            WaTech&apos;s Policy USER-01 already requires WCAG 2.1 AA
            compliance, Accessibility Coordinators in every agency, and formal
            compliance plans — and the state is moving to WCAG 2.2 AA by July
            2026. On top of that, the federal ADA Title II deadline means every
            public-facing PDF needs to be accessible now. CASO Comply
            remediates documents at scale so your team can focus on the plan,
            not the grunt work.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Washington has one of the most detailed state-level digital
              accessibility frameworks in the country — complete with designated
              coordinators and formal compliance plans. CASO Comply handles the
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              ...
              includes documents posted on the site — which is why public-facing
              PDFs are in scope alongside websites and apps.
            </p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Washington agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Washington entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Washington document accessibility — from
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                Utah Technology Governance Act and ADA Title II compliance for state agencies.
              </p>
            </Link>
            <Link
