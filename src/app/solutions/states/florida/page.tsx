...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Florida — CASO Comply",
  description:
    "Florida Statutes §282.602-282.603 require accessible EIT conforming to Section 508. Meet ADA Title II deadlines with automated PDF remediation from CASO Comply.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Florida — CASO Comply",
    description:
      "Florida Statutes §282.602-282.603 require accessible EIT conforming to Section 508. Meet ADA Title II deadlines with automated PDF remediation from CASO Comply.",
  ...
  alternates: {
    canonical: "/solutions/states/florida",
  },
};
...
const STATE_LAWS = [
  {
    title: "Florida Statutes §282.602–282.603",
    description:
  ...
  {
    title: "Florida DMS Accessibility Statement",
    description:
  ...
  {
    title: "Florida Department of State — PDF Accessibility",
    description:
  ...
  {
    title: "Florida DOE Website Accessibility Protocol",
    description:
  ...
  {
    title: "Florida Courts Accessibility Statements",
    description:
...
export default function FloridaSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Florida already has a state law on the books — Florida Statutes
            &sect;282.602&ndash;282.603 — that says state agencies must develop,
            procure, maintain, and use accessible electronic information
            technology that conforms to Section 508. Florida&apos;s own agencies
            are already telling people that includes the PDFs and documents they
            post. With the DOJ&apos;s ADA Title II web rule, most Florida
            entities serving 50,000+ people will need their public-facing PDFs to
            meet WCAG 2.1 AA by April 24, 2026. CASO Comply lets them fix those
            in minutes instead of doing them one by one.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Florida already tells agencies and districts: if you put PDFs on the
              site, they need to meet Section 508 and WCAG. CASO Comply lets you
              do that for hundreds or thousands at once.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              ...
              includes documents posted on the site — that is exactly the PDFs on
              fl.gov, county sites, school portals, and college sites. Active PDFs
              are in scope; older archived content can be excepted until someone
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Florida agencies, counties, and school districts serving
                populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Florida jurisdictions, school districts, and special
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Florida document accessibility — from
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                Texas EIR accessibility rules and ADA Title II compliance.
              </p>
            </Link>
            <Link
