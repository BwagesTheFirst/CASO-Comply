...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Hawaii — CASO Comply",
  description:
    "Hawaii agencies must meet Act 172 (SLH 2022) EIT accessibility standards and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Hawaii — CASO Comply",
    description:
      "Hawaii agencies must meet Act 172 (SLH 2022) EIT accessibility standards and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/hawaii",
  },
};
...
const STATE_LAWS = [
  {
    title: "Act 172, Session Laws of Hawaii 2022",
    description:
  ...
  {
    title: "Hawaii EIT Disability Access Standards",
    description:
  ...
  {
    title: "HRS § 368-1.5 — Civil Rights Commission Enforcement",
    description:
  ...
  {
    title: "Section 508 & ADA Title II Alignment",
    description:
...
const THREE_REASONS = [
  {
    title: "Meet Act 172 Without Growing Your Team",
    description:
  ...
  {
    title: "Avoid Civil Rights Commission Complaints",
    description:
  ...
  {
    title: "Island-Wide Coverage, Centralized Compliance",
    description:
...
export default function HawaiiSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            ...
            Technology Accessibility Act — requiring every state entity to make
            its digital content accessible. That includes PDFs, forms, and
            documents posted on agency websites. With the federal ADA Title II
            deadline now in play, Hawaii agencies need to move fast. CASO Comply
            remediates documents at scale so you can meet both state and federal
            requirements.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Act 172 made Hawaii one of the more recent states to codify EIT
              accessibility into law. The standards are clear: WCAG 2.1 AA for
              all state digital content. CASO Comply handles the document piece.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Hawaii agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Hawaii entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Hawaii document accessibility — from discovery
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                ITA Standard S5120 and ADA Title II compliance for Idaho state agencies.
              </p>
            </Link>
            <Link
              href="/solutions/states/indiana"
              className="group rounded-xl border border-caso-border bg-caso-navy-light p-6 transition-colors hover:border-caso-blue/50"
            >
              <h3 className="font-[family-name:var(--font-display)] text-lg font-bold text-caso-white group-hover:text-caso-blue">
                Indiana
              ...
              <p className="mt-2 text-sm text-caso-slate">
                IC 4-13.1-3 and ADA Title II compliance for Indiana public entities.
              </p>
            </Link>
          </div>
        </div>
