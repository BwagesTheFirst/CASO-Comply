...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Wisconsin — CASO Comply",
  description:
    "Wisconsin agencies must meet DET accessibility standards (Wis. Stat. 16.971) and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Wisconsin — CASO Comply",
    description:
      "Wisconsin agencies must meet DET accessibility standards (Wis. Stat. 16.971) and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/wisconsin",
  },
};
...
const STATE_LAWS = [
  {
    title: "Wis. Stat. 16.971–16.975 — DET Authority",
    description:
  ...
  {
    title: "Wisconsin DOJ Section 508 Guidelines",
    description:
  ...
  {
    title: "DET IT Procurement Accessibility Standards",
    description:
  ...
  {
    title: "Federal ADA Title II (Applies to All Wisconsin Public Entities)",
    description:
...
export default function WisconsinSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Wisconsin has included accessibility in its IT procurement standards
            and DET policies for years, and the DOJ&apos;s Section 508
            guidelines cover state agency websites. But the federal ADA Title II
            rule is the first time there&apos;s an enforceable deadline — and it
            covers documents too. For Wisconsin agencies, that means every
            public-facing PDF needs to meet WCAG 2.1 AA. CASO Comply
            remediates them at scale so you don&apos;t have to do it manually.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Wisconsin has folded accessibility into IT procurement and DET
              policies, and the DOJ has established Section 508 guidelines. The
              federal ADA Title II rule now adds enforceable deadlines. CASO
              Comply handles the document side at scale.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              ...
              includes documents posted on the site — making this Wisconsin&apos;s
              first enforceable deadline for PDF accessibility.
            </p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Wisconsin agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Wisconsin entities and municipalities serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Wisconsin document accessibility — from
