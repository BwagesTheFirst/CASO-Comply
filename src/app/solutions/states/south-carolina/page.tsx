...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for South Carolina — CASO Comply",
  description:
    "South Carolina expects accessible digital content from state and local entities. Meet ADA Title II deadlines with automated PDF remediation from CASO Comply.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for South Carolina — CASO Comply",
    description:
      "South Carolina expects accessible digital content from state and local entities. Meet ADA Title II deadlines with automated PDF remediation from CASO Comply.",
  ...
  alternates: {
    canonical: "/solutions/states/south-carolina",
  },
};
...
const STATE_LAWS = [
  {
    title: "SC.GOV Accessibility Policy",
    description:
  ...
  {
    title: "SC Department of Education Standards",
    description:
  ...
  {
    title: "University of South Carolina WCAG 2.1 AA Policy",
    description:
  ...
  {
    title: "Municipal Accessibility Guidance",
    description:
...
const THREE_REASONS = [
  ...
  {
    title: "No In-House Accessibility Expertise Required",
    description:
...
export default function SouthCarolinaSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-sm font-bold uppercase tracking-widest text-caso-glacier">
            Solutions for South Carolina
          </p>
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            Digital Accessibility Compliance for South Carolina
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            South Carolina already expects state and local entities to publish
            accessible digital content — and now the federal ADA Title II web
            rule adds firm deadlines. For most public-facing content people still
            use, including PDFs, agencies must meet WCAG 2.1 AA by April 24,
            2026. CASO Comply automates the remediation so you can meet those
            deadlines at scale.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              South Carolina already tells agencies and schools to make digital
              documents accessible — CASO Comply just does it at scale.
            </p>
          </div>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              The DOJ&apos;s ADA Title II rule requires web content — including
              documents posted on websites — to meet WCAG 2.1 AA. Active PDFs
              are in scope; archived content may be exempt.
            </p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                SC entities serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller SC entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for South Carolina document accessibility — from
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                Section 508 and ADA compliance for Florida agencies and school districts.
              </p>
            </Link>
            <Link
