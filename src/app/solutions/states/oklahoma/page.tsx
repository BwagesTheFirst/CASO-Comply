...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Oklahoma — CASO Comply",
  description:
    "Oklahoma agencies must meet the EITA Act and OMES ICT Accessibility Standards alongside the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Oklahoma — CASO Comply",
    description:
      "Oklahoma agencies must meet the EITA Act and OMES ICT Accessibility Standards alongside the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/oklahoma",
  },
};
...
const STATE_LAWS = [
  {
    title: "Oklahoma EITA Act (HB 2197, 2004)",
    description:
  ...
  {
    title: "OMES ICT Accessibility Standards",
    description:
  ...
  {
    title: "EITA Advisory Council Oversight",
    description:
  ...
  {
    title: "Comparable Access Mandate",
    description:
...
const THREE_REASONS = [
  {
    title: "Two Decades of Law, One Automated Fix",
    description:
  ...
  {
    title: "Cover Agencies, Higher Ed, and Career Tech",
    description:
...
export default function OklahomaSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Oklahoma has had its own accessibility law since 2004 — the
            Electronic Information Technology Accessibility Act requires state
            agencies, universities, and Career Tech to make digital content
            accessible. Now the federal ADA Title II rule adds hard deadlines.
            For Oklahoma entities, public-facing PDFs are squarely in scope.
            CASO Comply remediates them at scale instead of one at a time.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Oklahoma has had accessibility standards on the books for over two
              decades. OMES updated them in 2020 to match the refreshed Section
              508 standards. CASO Comply automates compliance at scale.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Oklahoma agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Oklahoma entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Oklahoma document accessibility — from discovery
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                EIR accessibility and ADA Title II compliance for Texas agencies and school districts.
              </p>
            </Link>
            <Link
              href="/solutions/states/tennessee"
              className="group rounded-xl border border-caso-border bg-caso-navy-light p-6 transition-colors hover:border-caso-blue/50"
            >
              <h3 className="font-[family-name:var(--font-display)] text-lg font-bold text-caso-white group-hover:text-caso-blue">
                Tennessee
              ...
              <p className="mt-2 text-sm text-caso-slate">
                ADA Title II compliance for Tennessee state and local government entities.
              </p>
            </Link>
          </div>
        </div>
