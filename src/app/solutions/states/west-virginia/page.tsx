...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for West Virginia — CASO Comply",
  description:
    "West Virginia agencies must meet Section 508, WV Code 5A-6 Office of Technology policies, and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for West Virginia — CASO Comply",
    description:
      "West Virginia agencies must meet Section 508, WV Code 5A-6 Office of Technology policies, and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/west-virginia",
  },
};
...
const STATE_LAWS = [
  {
    title: "WV Code 5A-6 — Office of Technology",
    description:
  ...
  {
    title: "Section 508 Compliance (State-Adopted)",
    description:
  ...
  {
    title: "WVOT IT Policies for Executive Branch",
    description:
  ...
  {
    title: "Federal ADA Title II (Applies to All WV Public Entities)",
    description:
...
export default function WestVirginiaSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          <p className="text-sm font-bold uppercase tracking-widest text-caso-glacier">
            Solutions for West Virginia
          </p>
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            West Virginia Section 508 + ADA Title II Compliance
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            West Virginia agencies already follow Section 508 under the Office
            of Technology&apos;s enterprise IT policies, but the federal ADA
            Title II rule raises the bar to WCAG 2.1 AA — and puts a hard
            deadline on it. For West Virginia state and local governments, that
            means every public-facing PDF still in use needs to be accessible.
            CASO Comply remediates those documents at scale so your team
            doesn&apos;t have to do them one by one.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              West Virginia has followed Section 508 for years through the
              Office of Technology&apos;s enterprise policies. The ADA Title II
              rule now adds WCAG 2.1 AA as the enforceable standard. CASO Comply
              handles the document side at scale.
            </p>
          </div>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              The DOJ&apos;s ADA Title II web rule goes beyond Section 508 —
              requiring WCAG 2.1 AA compliance for all web content, including
              PDFs posted on government websites.
            </p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                West Virginia agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller West Virginia entities and counties serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for West Virginia document accessibility — from
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                North Dakota accessibility standards and ADA Title II compliance.
              </p>
            </Link>
          </div>
        </div>
