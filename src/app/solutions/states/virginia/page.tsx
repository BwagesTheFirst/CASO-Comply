...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Virginia — CASO Comply",
  description:
    "Virginia agencies must meet the Information Technology Access Act (HB2541), VITA Standard GOV103, and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Virginia — CASO Comply",
    description:
      "Virginia agencies must meet the Information Technology Access Act (HB2541), VITA Standard GOV103, and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/virginia",
  },
};
...
const STATE_LAWS = [
  {
    title: "Virginia Information Technology Access Act (HB2541)",
    description:
  ...
  {
    title: "VITA Standard GOV103 — IT Accessibility",
    description:
  ...
  {
    title: "HB2541 Vendor Accountability Requirements",
    description:
  ...
  {
    title: "Digital Accessibility Coordinator Mandate",
    description:
...
export default function VirginiaSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Virginia just raised the bar. HB2541 updated the Information
            Technology Access Act in 2025 to cover all disabilities and require
            vendor accessibility reporting. Combined with VITA&apos;s GOV103
            standard and the federal ADA Title II deadline, Virginia agencies
            face some of the most comprehensive accessibility requirements in
            the country. CASO Comply handles the document remediation piece —
            thousands of PDFs fixed in days, not months.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Virginia has some of the strongest state-level accessibility
              requirements in the U.S. — including vendor accountability rules
              that most states don&apos;t have. CASO Comply helps you meet them.
            </p>
          </div>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              The DOJ&apos;s ADA Title II web rule treats posted documents as
              &ldquo;web content&rdquo; — and Virginia&apos;s HB2541 explicitly
              aligns its state deadlines with the federal timeline.
            </p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Virginia agencies serving populations of{" "}
                <span className="font-semibold text-caso-white">
                  50,000 or more
                </span>{" "}
                plus state agencies and universities
              </p>
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Virginia entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Virginia document accessibility — from discovery
      ...
      <section className="border-t border-caso-border px-6 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Link
              href="/solutions/states/west-virginia"
              className="group rounded-xl border border-caso-border bg-caso-navy-light p-6 transition-colors hover:border-caso-blue/50"
            >
              <h3 className="font-[family-name:var(--font-display)] text-lg font-bold text-caso-white group-hover:text-caso-blue">
                West Virginia
              ...
              <p className="mt-2 text-sm text-caso-slate">
                Section 508 and ADA Title II compliance for West Virginia state agencies.
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                South Carolina accessibility requirements and ADA Title II compliance.
              </p>
            </Link>
          </div>
        </div>
