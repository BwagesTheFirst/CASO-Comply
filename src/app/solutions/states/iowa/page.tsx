...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Iowa — CASO Comply",
  description:
    "Iowa agencies must meet the OCIO Website Accessibility Standard (WCAG 2.0 AA) and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Iowa — CASO Comply",
    description:
      "Iowa agencies must meet the OCIO Website Accessibility Standard (WCAG 2.0 AA) and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/iowa",
  },
};
...
const STATE_LAWS = [
  {
    title: "OCIO Website Accessibility Standard",
    description:
  ...
  {
    title: "Biennial Standard Review",
    description:
  ...
  {
    title: "Section 508 Supersession Clause",
    description:
...
const THREE_REASONS = [
  {
    title: "Bridge the Gap from WCAG 2.0 to 2.1",
    description:
  ...
  {
    title: "Keep Vendors and Contractors in Line",
    description:
...
export default function IowaSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Iowa&apos;s OCIO Website Accessibility Standard already requires
            WCAG conformance for every state agency, board, and commission — and
            it extends to contractors too. Now the federal ADA Title II rule
            raises the bar to WCAG 2.1 AA with a hard deadline. CASO Comply
            remediates your PDFs and documents to meet both standards, so you
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Iowa has a clear accessibility standard managed by the OCIO, with
              biennial reviews and vendor compliance requirements. CASO Comply
              handles the document remediation at scale.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Iowa agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Iowa entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Iowa document accessibility — from discovery
