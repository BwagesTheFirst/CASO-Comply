...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Oregon — CASO Comply",
  description:
    "Oregon agencies must meet DAS statewide accessibility policies, ORS 276A IT standards, and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Oregon — CASO Comply",
    description:
      "Oregon agencies must meet DAS statewide accessibility policies, ORS 276A IT standards, and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/oregon",
  },
};
...
const STATE_LAWS = [
  {
    title: "ORS 276A — Information Technology Governance",
    description:
  ...
  {
    title: "DAS Statewide Accessibility Policy",
    description:
  ...
  {
    title: "ORS 276A.365 — Information Management",
    description:
  ...
  {
    title: "Oregon Accessibility Statement Requirements",
    description:
...
const THREE_REASONS = [
  {
    title: "Clear the Document Backlog Fast",
    description:
  ...
  {
    title: "Built for Oregon's Transparency Standards",
    description:
...
export default function OregonSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Oregon&apos;s DAS statewide policies and ORS 276A already require
            state agencies to make digital content accessible, and the state
            emphasizes plain-language, no-cost access to public information.
            Now the federal ADA Title II rule puts enforceable deadlines on it.
            For Oregon agencies, that means public-facing PDFs need to be
            WCAG 2.1 AA compliant. CASO Comply handles that at scale.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Oregon&apos;s IT governance framework and DAS policies already
              mandate accessible digital content. CASO Comply automates the
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Oregon agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Oregon entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Oregon document accessibility — from discovery
      ...
      <section className="border-t border-caso-border px-6 py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Link
              href="/solutions/states/south-dakota"
              className="group rounded-xl border border-caso-border bg-caso-navy-light p-6 transition-colors hover:border-caso-blue/50"
            >
              <h3 className="font-[family-name:var(--font-display)] text-lg font-bold text-caso-white group-hover:text-caso-blue">
                South Dakota
              ...
              <p className="mt-2 text-sm text-caso-slate">
                BIT accessibility standards and ADA Title II compliance for South Dakota agencies.
              </p>
            </Link>
          </div>
        </div>
