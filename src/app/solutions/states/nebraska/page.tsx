...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Nebraska — CASO Comply",
  description:
    "Nebraska's NITC Technical Standard 2-101 requires state agencies to meet Revised Section 508 and WCAG 2.1 AA accessibility standards. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Nebraska — CASO Comply",
    description:
      "Nebraska's NITC Technical Standard 2-101 requires state agencies to meet Revised Section 508 and WCAG 2.1 AA accessibility standards. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/nebraska",
  },
};
...
const STATE_LAWS = [
  {
    title: "NITC Technical Standard 2-101",
    description:
  ...
  {
    title: "NITC WCAG 2.1 AA Requirement",
    description:
  ...
  {
    title: "Nebraska OCIO Accessibility Guidance",
    description:
  ...
  {
    title: "Neb. Rev. Stat. 86-524 — NITC Authority",
    description:
...
const THREE_REASONS = [
  {
    title: "NITC Standards Are Already Enforceable",
    description:
  ...
  {
    title: "Scale Across Nebraska's Agency Landscape",
    description:
...
export default function NebraskaSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Nebraska&apos;s NITC Technical Standard 2-101 has required accessible
            information technology since 2001, updated in 2019 to reference WCAG
            2.1. Now the federal ADA Title II rule puts a firm deadline on it.
            For Nebraska agencies, that means every public-facing PDF needs to be
            accessible — and CASO Comply handles that at scale.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Nebraska&apos;s NITC has had accessibility standards in place for
              over two decades. The federal deadline adds urgency to what the
              state already expects.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              ...
              putting PDFs squarely in scope for Nebraska agencies.
            </p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Nebraska agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Nebraska entities and counties serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Nebraska document accessibility — from
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                MCA 18-5-601 IT Access Act and ADA Title II compliance for Montana agencies.
              </p>
            </Link>
            <Link
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                Accessibility standards and ADA Title II compliance for Minnesota public entities.
              </p>
            </Link>
          </div>
        </div>
