...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Idaho — CASO Comply",
  description:
    "Idaho agencies must meet ITA Standard S5120, the state Web Publishing Policy (WCAG 2.1 AA), and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Idaho — CASO Comply",
    description:
      "Idaho agencies must meet ITA Standard S5120, the state Web Publishing Policy (WCAG 2.1 AA), and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/idaho",
  },
};
...
const STATE_LAWS = [
  {
    title: "ITA Standard S5120 — Web Publishing",
    description:
      "Idaho's Web Publishing Policy applies to all public-facing web pages developed by or for state agencies, requiring compliance with ADA and Section 508 guidelines including WCAG 2.1 Level AA.",
  },
  {
    title: "WCAG 2.1 AA + Guideline 3.2.5 (AAA)",
    description:
      "Idaho goes beyond typical state requirements by mandating WCAG 2.1 Level AA conformance plus Guideline 3.2.5 from Level AAA, which requires that changes of context be initiated only by user request.",
  },
  {
    title: "ITS Digital Accessibility Program",
    description:
      "The Office of Information Technology Services coordinates accessibility efforts statewide, providing scanning software and resources while requiring each agency to remediate its own content.",
  },
  {
    title: "ADA & Section 508 Compliance",
    description:
      "Idaho's web publishing guidelines explicitly require conformance with the Americans with Disabilities Act and Section 508, covering all digital content including documents published on state websites.",
  },
];
...
const THREE_REASONS = [
  {
    title: "Complement What ITS Already Provides",
    description:
      "Idaho's ITS is rolling out scanning software for state websites, but scanning only finds the problems — it doesn't fix them. CASO Comply picks up where scanning leaves off, automatically remediating the PDFs and documents that get flagged.",
  },
  {
    title: "Shared Responsibility, Simplified",
    description:
      "Idaho treats accessibility as a shared responsibility between ITS and individual agencies. CASO Comply gives each agency a self-service way to remediate their own documents without waiting on central IT or hiring outside vendors.",
  },
  {
    title: "No Accessibility Expertise Required",
    description:
      "Most Idaho agencies don't have WCAG or PDF/UA specialists on staff. CASO Comply applies the right structure tags, alt text, and metadata automatically — so your team can meet S5120 and the federal ADA deadline without specialized training.",
  },
];

export default function IdahoSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            Idaho Web Publishing Accessibility + ADA Title II Compliance
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Idaho&apos;s ITA Standard S5120 already requires WCAG 2.1 AA for all
            state agency web content — and the state even goes a step further by
            requiring one AAA-level guideline. With ITS now deploying scanning
            tools statewide and the federal ADA deadline in effect, Idaho
            agencies need a way to actually fix what gets flagged. CASO Comply
            remediates documents at scale so your team can close the gap fast.
          </p>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            <h2 className="font-[family-name:var(--font-display)] text-3xl font-bold md:text-4xl">
              What Idaho Already Requires
            </h2>
            <p className="mt-4 text-lg text-caso-slate">
              Idaho has clear web publishing standards and an active ITS program
              pushing agencies toward compliance. CASO Comply automates the
              document remediation that makes it real.
            </p>
          </div>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            <h2 className="font-[family-name:var(--font-display)] text-3xl font-bold md:text-4xl">
              The Federal Clock Idaho Is Following
            </h2>
            <p className="mt-4 text-lg text-caso-slate">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Idaho agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Idaho entities and special districts serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 bg-caso-navy-light px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            <h2 className="font-[family-name:var(--font-display)] text-3xl font-bold md:text-4xl">
              Why Idaho Entities Choose CASO Comply
            </h2>
          </div>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Idaho document accessibility — from discovery
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                OCIO Website Accessibility Standard and ADA Title II compliance for Iowa agencies.
              </p>
            </Link>
            <Link
              href="/solutions/states/kansas"
              className="group rounded-xl border border-caso-border bg-caso-navy-light p-6 transition-colors hover:border-caso-blue/50"
            >
              <h3 className="font-[family-name:var(--font-display)] text-lg font-bold text-caso-white group-hover:text-caso-blue">
                Kansas
              ...
              <p className="mt-2 text-sm text-caso-slate">
                ITEC Policy 1210 and ADA Title II compliance for Kansas state entities.
              </p>
            </Link>
          </div>
        </div>
      ...
      <section className="px-6 py-20 md:py-28">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="font-[family-name:var(--font-display)] text-3xl font-bold md:text-4xl">
            Start Your Idaho Compliance Assessment
          </h2>
          <p className="mt-4 text-lg text-caso-slate">
