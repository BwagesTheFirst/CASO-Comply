...
export const metadata: Metadata = {
  title: "ADA & PDF Accessibility Compliance for Vermont — CASO Comply",
  description:
    "Vermont agencies must meet the Agency of Digital Services (ADS) accessibility policies and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  openGraph: {
    title: "ADA & PDF Accessibility Compliance for Vermont — CASO Comply",
    description:
      "Vermont agencies must meet the Agency of Digital Services (ADS) accessibility policies and the federal ADA Title II deadline. CASO Comply automates PDF remediation at scale.",
  ...
  alternates: {
    canonical: "/solutions/states/vermont",
  },
};
...
const STATE_LAWS = [
  {
    title: "3 V.S.A. Chapter 56 — Agency of Digital Services",
    description:
  ...
  {
    title: "Vermont Universal Digital Accessibility Initiative",
    description:
  ...
  {
    title: "ADS Statewide Accessibility Policies",
    description:
  ...
  {
    title: "Federal ADA Title II (Applies to All Vermont Public Entities)",
    description:
...
export default function VermontSolutionPage() {
  return (
    <MarketingLayout>
      {/* Hero */}
      <section className="border-b border-caso-border/50 px-6 py-20 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mt-4 font-[family-name:var(--font-display)] text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
            Vermont Digital Accessibility + ADA Title II Compliance
          </h1>
          <p className="mt-6 text-lg leading-relaxed text-caso-slate md:text-xl">
            Vermont&apos;s Agency of Digital Services already sets statewide
            accessibility policies, and the state launched its Universal Digital
            Accessibility Initiative to get ahead of the curve. Now the federal
            ADA Title II rule puts a hard deadline on it — every public-facing PDF
            on a Vermont government website needs to be WCAG 2.1 AA compliant.
            CASO Comply remediates those documents at scale so you don&apos;t have
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              Vermont has proactively built accessibility into its digital
              governance through ADS policies and the Universal Digital
              Accessibility Initiative. CASO Comply handles the document
              remediation piece at scale.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              ...
              includes documents posted on the site — which means PDFs on Vermont
              municipal and state agency websites are in scope.
            </p>
          </div>
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-red-500/30 bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Vermont agencies serving populations of{" "}
            ...
            <div className="rounded-2xl border border-caso-border bg-caso-navy-light p-8">
              ...
              <p className="mt-2 text-caso-slate">
                Smaller Vermont municipalities and entities serving populations{" "}
                <span className="font-semibold text-caso-white">
                  under 50,000
                </span>
              </p>
      ...
      <section className="border-b border-caso-border/50 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-caso-slate">
              A complete solution for Vermont document accessibility — from discovery
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            >
              ...
              <p className="mt-2 text-sm text-caso-slate">
                New York State Technology Law and ADA Title II compliance for state and local agencies.
              </p>
            </Link>
            <Link
              href="/solutions/states/virginia"
              className="group rounded-xl border border-caso-border bg-caso-navy-light p-6 transition-colors hover:border-caso-blue/50"
            >
              <h3 className="font-[family-name:var(--font-display)] text-lg font-bold text-caso-white group-hover:text-caso-blue">
                Virginia
              ...
              <p className="mt-2 text-sm text-caso-slate">
                Virginia Information Technology Access Act and ADA Title II compliance.
              </p>
            </Link>
          </div>
        </div>
