                ...
                <ul className="mt-3 space-y-1" role="list">
                  <li role="none">
                    <Link
                      ...
                      role="menuitem"
                      className="flex items-start gap-2 rounded-lg px-3 py-2 transition-colors hover:bg-caso-navy-mid focus-visible:ring-2 focus-visible:ring-caso-blue"
                  ...
                  <li role="none">
                    <span className="flex items-start gap-2 rounded-lg px-3 py-2 opacity-50" aria-disabled="true">
